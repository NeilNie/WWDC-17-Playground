...
var numbers = "1, 2, 3, 4"
/*:
 You can probably easily recognize those numbers above. We has humans can do effortlessly and accurately. Imagine if we can create a program that can allow computers to do the same. This problem seems simple, "Neil, we are just telling the machines to read 10 numbers!".
...
/*:
 How do we solve the problem of computer vision or natural language processing? One of the most effective ways is to let the computer develop it's own knowledge through learning. Scientists discovered a great machine learning method that is somewhat similar to human neurons, it's called neural networks. In the Today, we will combine one of the most powerful machine leanring algorithm with one of the most elegant programming languages and create a neural network in Swift.
 */
/*:
 [Table of Contents](Table%20of%20contents) | [Next](Understanding%20neural%20networks)
 */
